...
class Read extends Component
{
    ...
    protected $listeners = ['authorDeleted'];
    ...
    public function render()
    {
        ...
        return view('livewire.admin.author.read', [
            'authors' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Author')) ]);
    }
}
