...
class Read extends Component
{
    ...
    protected $listeners = ['translatorDeleted'];

    public $sortType;
    public $sortColumn;

    public function translatorDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        $instance = getCrudConfig('translator');
        ...
        return view('livewire.admin.translator.read', [
            'translators' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Translator')) ]);
    }
}
