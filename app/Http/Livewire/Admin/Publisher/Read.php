...
class Read extends Component
{
    ...
    protected $listeners = ['publisherDeleted'];

    public $sortType;
    public $sortColumn;

    public function publisherDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        $instance = getCrudConfig('publisher');
        ...
        return view('livewire.admin.publisher.read', [
            'publishers' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Publisher')) ]);
    }
}
