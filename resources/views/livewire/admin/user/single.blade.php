<tr x-data="{ modalIsOpen : false }">
    ...
    <td> {{ $user->email }} </td>
    <td> 
        @if($user->is_superuser) <span class="badge badge-success">Yes</span> @else <span class="badge badge-warning">No</span> @endif 
    ...
    @if(getCrudConfig('user')->delete or getCrudConfig('user')->update)
        <td>
            ...
            @if(getCrudConfig('user')->update)
                <a href="@route(getRouteName().'.users.update', ['user' => $user->id])" class="btn text-primary mt-1">
