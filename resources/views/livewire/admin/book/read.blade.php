                ...
                <div class="px-2 mt-4">
                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                        ...
                        <div class="col-md-4 right-0">
                            <a href="@route(getRouteName().'.books.create')" class="btn btn-success">{{ __('CreateTitle', ['name' => __('Book') ]) }}</a>
                        </div>
                        @endif
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style='cursor: pointer' wire:click="sort('picture')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'picture') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'picture') fa-sort-amount-up ml-2 @endif'></i> {{ __('Picture') }} </td>
